...
export default{
    ...
    methods:{
        sendApply(){
            const webhookUrl = https://discord.com/api/webhooks/1245433743250821171/_E6sqyJ-Pw2Y7xDc9vc3WkwajxFd0ypmyhoOoJ75cTKwTP-j_LKn8JWDeP6ZTgeckRG-'
...
<template>
    <div class="main">
        <div class="apply">
            <div class="cont">
                <RouterLink to="/">
                    <img src="https://media.discordapp.net/attachments/1229488327124586607/1235930332235169885/C98CBA3F-7E7E-49D8-A8F0-0826D4BFB9CF.png?ex=6646a411&is=66455291&hm=a7c75e65aa38e3748f25d78af407d263329005b95c883bf7276729e4324882a7&=&format=webp&quality=lossless&width=200&height=200" alt="Lamsa Logo">
                </RouterLink>
                <div class="inp">
